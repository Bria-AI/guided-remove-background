.PHONY: setup images run serve benchmark export clean help
...
run: images ## Run all benchmark cases (requires API keys in .env)
...
export: ## Export results as a single shareable HTML file
